...
public interface IApiEventPublisher
{
    ...
    event ClientPairRequestEventHandler ClientPairRequestEvent;

    public delegate void ProfilesUpdatedEventHandler(List<Profile> profiles);
    event ProfilesUpdatedEventHandler ProfilesUpdatedEvent;

    public delegate void LobbyCreatedEventEventHandler(string lobbyJson);
    ...
    event ImageUpdatedEventHandler DockerImageUpdatedEvent;
    
    public delegate void ImageAlreadyUptoDateEventHandler(string imageName);
    event ImageAlreadyUptoDateEventHandler DockerImageAlreadyUptoDateEvent;

    public delegate void ImagePullProgressEventHandler(string imageName, double progress);
    event ImagePullProgressEventHandler DockerImagePullProgressEvent;
